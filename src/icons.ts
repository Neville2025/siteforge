...
export const ICONS: Record<string, IconDef> = {
  ...
  'thumbs-up': { name:'thumbs-up', label:'Thumbs up', category:'Trust', body: stroke(`<path d="M14 9V5a3 3 0 0 0-6 0v4H4v12h13a4 4 0 0 0 4-4l-1-7a3 3 0 0 0-3-3z" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/>`) },
  ...
  'map-pin':  { name:'map-pin', label:'Map pin', category:'Contact', body: stroke(`<path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/><circle cx="12" cy="10" r="3" fill="none" stroke="currentColor" stroke-width="1.8"/>`) },
