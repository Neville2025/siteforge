...
function css(theme: Theme) {
  ...
  return `
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .mobile-menu{display:none;position:fixed;top:64px;left:0;right:0;background:${theme.style==='dark'?'#0a0a0a':'#fff'};border-bottom:1px solid ${theme.style==='dark'?'#222':'#eee'};padding:20px 24px;flex-direction:column;gap:16px;z-index:99;box-shadow:0 12px 32px rgba(0,0,0,.18)}
...
<div id="sf-mobile-menu" class="mobile-menu">${links}</div>
